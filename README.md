...
- 📁 **File Operations** - Read, write, and edit files with syntax highlighting and intelligent modifications, and discover files with glob patterns
...
| glob | `agent.tool.glob(pattern="**/*.json", path="configs/")` | Find files matching glob patterns, supports recursive matching with ** syntax |
