...
| NEPTUNE_ANALYTICS_HOST | Neptune Analytics Host URL | None | Neptune Analytics |
...
- If `NEPTUNE_ANALYTICS_HOST` is set, the tool will configure Neptune Analytics as graph store to enhance memory search
